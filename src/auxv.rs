...
mod tests {
    ...
    const OS_TYPES: [(Type, Word); 8] = [
        ...
        // (Type::AT_CANARYLEN, atc!(AT_CANARYLEN)),
        (Type::AT_OSRELDATE, atc!(AT_OSRELDATE)),
        (Type::AT_NCPUS, atc!(AT_NCPUS)),
        // (Type::AT_PAGESIZES, atc!(AT_PAGESIZES)),
        // (Type::AT_PAGESIZESLEN, atc!(AT_PAGESIZESLEN)),
        (Type::AT_TIMEKEEP, atc!(AT_TIMEKEEP)),
        // (Type::AT_STACKPROT, atc!(AT_STACKPROT)),
        // (Type::AT_EHDRFLAGS, atc!(AT_EHDRFLAGS)),
        (Type::AT_HWCAP, atc!(AT_HWCAP)),
        // (Type::AT_BSDFLAGS, atc!(AT_BSDFLAGS)),
        // (Type::AT_ARGC, atc!(AT_ARGC)),
        // (Type::AT_ARGV, atc!(AT_ARGV)),
        // (Type::AT_ENVC, atc!(AT_ENVC)),
        // (Type::AT_ENVV, atc!(AT_ENVV)),
        // (Type::AT_PS_STRINGS, atc!(AT_PS_STRINGS)),
        // (Type::AT_FXRNG, atc!(AT_FXRNG)),
        // (Type::AT_KPRELOAD, atc!(AT_KPRELOAD)),
        (Type::AT_USRSTACKBASE, atc!(AT_USRSTACKBASE)),
        (Type::AT_USRSTACKLIM, atc!(AT_USRSTACKLIM)),
        // (Type::AT_COUNT, atc!(AT_COUNT)),
    ];
    ...
    const OS_TYPES: [(Type, Word); 8] = [
        ...
        (Type::AT_HWCAP, atc!(AT_HWCAP)),
        (Type::AT_CLKTCK, atc!(AT_CLKTCK)),
        // (Type::AT_FPUCW, atc!(AT_FPUCW)),
        // (Type::AT_DCACHEBSIZE, atc!(AT_DCACHEBSIZE)),
        // (Type::AT_ICACHEBSIZE, atc!(AT_ICACHEBSIZE)),
        // (Type::AT_UCACHEBSIZE, atc!(AT_UCACHEBSIZE)),
        // (Type::AT_IGNOREPPC, atc!(AT_IGNOREPPC)),
        (Type::AT_SECURE, atc!(AT_SECURE)),
        (Type::AT_BASE_PLATFORM, atc!(AT_BASE_PLATFORM)),
        (Type::AT_RANDOM, atc!(AT_RANDOM)),
        // (Type::AT_RSEQ_FEATURE_SIZE, atc!(AT_RSEQ_FEATURE_SIZE)),
        // (Type::AT_RSEQ_ALIGN, atc!(AT_RSEQ_ALIGN)),
        // (Type::AT_HWCAP3, atc!(AT_HWCAP3)),
        // (Type::AT_HWCAP4, atc!(AT_HWCAP4)),
        (Type::AT_EXECFN, atc!(AT_EXECFN)),
        // (Type::AT_SYSINFO, atc!(AT_SYSINFO)),
        (Type::AT_SYSINFO_EHDR, atc!(AT_SYSINFO_EHDR)),
        // (Type::AT_L1I_CACHESHAPE, atc!(AT_L1I_CACHESHAPE)),
        // (Type::AT_L1D_CACHESHAPE, atc!(AT_L1D_CACHESHAPE)),
        // (Type::AT_L2_CACHESHAPE, atc!(AT_L2_CACHESHAPE)),
        // (Type::AT_L3_CACHESHAPE, atc!(AT_L3_CACHESHAPE)),
        // (Type::AT_L1I_CACHESIZE, atc!(AT_L1I_CACHESIZE)),
        // (Type::AT_L1I_CACHEGEOMETRY, atc!(AT_L1I_CACHEGEOMETRY)),
        // (Type::AT_L1D_CACHESIZE, atc!(AT_L1D_CACHESIZE)),
        // (Type::AT_L1D_CACHEGEOMETRY, atc!(AT_L1D_CACHEGEOMETRY)),
        // (Type::AT_L2_CACHESIZE, atc!(AT_L2_CACHESIZE)),
        // (Type::AT_L2_CACHEGEOMETRY, atc!(AT_L2_CACHEGEOMETRY)),
        // (Type::AT_L3_CACHESIZE, atc!(AT_L3_CACHESIZE)),
        // (Type::AT_L3_CACHEGEOMETRY, atc!(AT_L3_CACHEGEOMETRY)),
    ...
    fn test_libc_compat() {
        ...
        for (got, want) in BASE_TYPES.into_iter().chain(OS_TYPES) {
            ...
            let want = sys_getauxval(atc!(AT_HWCAP));
            println!(" got = {got:?}");
            println!("want = {want:?}");
            assert_eq!(got, want);
        }
